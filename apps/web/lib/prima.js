...
/**
 * prima theme — built by `npx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { primaTheme } from './prima';
 *   import './prima.css';
 */
export const primaTheme = {
  ...
  tokens: {
    ...
    "--color-background-body": "light-dark(#f5f5f6, #171717)",
    "--color-background-card": "light-dark(#ffffff, #1f1f1f)",
    "--color-background-popover": "light-dark(#FFFBFA, #352F2E)",
    "--color-background-muted": "light-dark(#f1f1f2, #202020)",
    "--color-accent": "light-dark(#ed2428, #ff6b70)",
    "--color-accent-muted": "light-dark(#ffe7e8, #5d1f22)",
    "--color-neutral": "light-dark(#201A191A, #E9E1DF33)",
    "--color-overlay": "light-dark(#201A1966, #201A1999)",
    "--color-overlay-hover": "light-dark(#201A190D, #FFFFFF0D)",
    "--color-overlay-pressed": "light-dark(#201A191A, #FFFFFF1A)",
    "--color-text-primary": "light-dark(#201A19, #E9E1DF)",
    "--color-text-secondary": "light-dark(#504442, #B7A8A5)",
    "--color-text-disabled": "light-dark(#9C8D8B, #695B59)",
    "--color-text-accent": "light-dark(#c91d21, #ff8b8f)",
    ...
    "--color-icon-accent": "light-dark(#ed2428, #ff6b70)",
    "--color-icon-primary": "light-dark(#201A19, #E9E1DF)",
    "--color-icon-secondary": "light-dark(#504442, #B7A8A5)",
    "--color-icon-disabled": "light-dark(#9C8D8B, #695B59)",
    "--color-success": "light-dark(#007004, #9fe59b)",
    "--color-error": "light-dark(#c91d21, #ff7d82)",
    "--color-warning": "light-dark(#745b00, #fdcf4f)",
    "--color-success-muted": "light-dark(#c5e5c0, #84c9803D)",
    "--color-error-muted": "light-dark(#ffe2e3, #ff7d8233)",
    "--color-warning-muted": "light-dark(#f8da9d, #deb4333D)",
    "--color-border": "light-dark(#e7e7e8, #ffffff1a)",
    "--color-border-emphasized": "light-dark(#cfcfd2, #5a5a60)",
    "--color-skeleton": "light-dark(#B7A8A5, #504442)",
    "--color-shadow": "light-dark(#0000001A, #0000004D)",
    "--color-tint-hover": "light-dark(black, white)",
    "--color-background-red": "light-dark(#ffe2e3, #ff7d8233)",
    "--color-border-red": "light-dark(#ed2428, #ff6b70)",
    "--color-icon-red": "light-dark(#ed2428, #ff6b70)",
    "--color-text-red": "light-dark(#9e1518, #ffb6b9)",
    ...
    "--color-background-inverted": "light-dark(#201A19, #FFFBFA)",
    "--color-track": "light-dark(#B7A8A5, #504442)",
    "--radius-chat": "25px"
  },
